...
import { HomeSvg, TilesSvg, OrdersSvg, SuppliersSvg, EmployeesSvg, DollarRateSvg, PromoCodeSvg, SignInSvg } from '../../Svgs/Icons';
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const links = [
    ...
    { name: 'Dollar Rate', icon: <DollarRateSvg />, to: '/dollarrate' },
    { name: 'Sign In', icon: <SignInSvg />, to: '/auth/signin' },
  ];
